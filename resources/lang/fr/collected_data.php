...
return [
    ...
    'confirmation' => [
        ...
        'cb1' => 'Je confirme que je souhaite demander la supprerssion de toutes les données me concernant stockées par ce module de connexion.',
        'cb2' => 'Je comprends que cette opération ne peut pas être annulée, et que toute mon activité sur cette plateforme sera supprimée sans aucun moyen de les récupérer.',
        'submit' => 'Confirmer'
    ],

    'alert' => [
        'p1' => 'Il est possible que certaines plateformes contiennent toujours des données liées à votre compte. Si la suppression des données sur ces plateformes ne fonctionne pas, veuillez contacter :',
        'p2' => 'Si vous ne recevez pas de réponse, vous pouvez contacter :email.'
    ]
];
