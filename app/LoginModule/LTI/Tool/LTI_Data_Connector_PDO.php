...
###
  public function Tool_Consumer_load($consumer) {
    ...
    $sql = 'SELECT name, secret, lti_version, consumer_name, consumer_version, consumer_guid, css_path, protected, enabled, enable_from, enable_until, last_access, created, updated, login_prefix ' .
    ...
    if ($ok) {
      ...
      $consumer->login_prefix = $row['login_prefix'];
