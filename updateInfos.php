...
$stmt = $db->prepare('update users set sFirstName = :sFirstName, sLastName = :sLastName, sStudentId = :sStudentId, sSex = :sSex, sEmail = :sEmail, iGraduationYear = :iGraduationYear where id = :idUser;');
$stmt->execute([
	'sFirstName' => $_POST['infos']['sFirstName'],
	'sLastName' => $_POST['infos']['sLastName'],
	'sStudentId' => $_POST['infos']['sStudentId'],
	'iGraduationYear' => $_POST['infos']['iGraduationYear'],
...
$_SESSION['modules']['login']['iGraduationYear'] = $_POST['infos']['iGraduationYear'];
